...
?>
        ...
        <tr>
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_titles_off.png" width="24" height="24" alt="" title="">H1 ->
                        H6 Tags
                    </div>
                    <div class="element">
                        <h1>Title - H1</h1>
            ...
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_titles_hover.png" width="24" height="24" alt="" title="">H1
                        -> H6 Tags with link
                    </div>
                    <div class="element">
    ...
    <table>
        <tr>
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_img_off.png" width="24" height="24" alt="" title="">Images
                    </div>
                    <div class="element">
            ...
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_img_hover.png" width="24" height="24" alt="" title="">Images
                        with link
                    </div>
                    <div class="element">
    ...
    <table>
        <tr>
            <td class="element-cell">
                <div class="element-name"><img src="ico_generic_fonts.png" width="24" height="24" alt="" title="">Generic
                    font class
                </div>
                                                            ...
                                                            <br>
                                                                ...
                                                                <br>
                                                                    ...
                                                                    <br>
                                                                        ...
                                                                        <br>
                                                                            <span
                                                                                    class="cursordefault">.cursordefault</span>
                                                                            <br>
                                                                                <span
                                                                                        class="cursormove">.cursormove</span>
                                                                                <br>
            ...
            <td class="element-cell">
                <div class="element-name"><img src="ico_general.png" width="24" height="24" alt="" title="">General
                    elements
                </div>
                <div class="element">
                    <a href="" title="">Link</a>
    ...
    <table>
        <tr>
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_table_tags.png" width="24" height="24" alt="" title="">Tables
                        tags
                    </div>
                    <div class="">
                        <table>
            ...
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_table_tags_hover.png" width="24" height="24" alt=""
                                                   title="">Tables tags - links
                    </div>
                    <div class="">
                        <table>
                            <tr>
    ...
    <table>
        <tr>
            ...
            <td class="element-cell">
                <div class="marginbot10">
                    <div class="element-name"><img src="ico_comments_hover.png" width="24" height="24" alt="" title="">Comments
                        .class - links
                    </div>
                    <div class="element">
    ...
    <div>
        <div class="element-name"><img src="package_editors.png" width="24" height="24" alt="" title="">Paragraph style
            & text selection
        </div>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque facilisis quam at ante tempor tempor. Mauris
            condimentum dignissim fringilla. Fusce ut enim id augue <a href="#"
                                                                       title="My title">dignissim
                molestie</a>. Proin nec lacus non leo ullamcorper scelerisque vitae in arcu. Donec
            fermentum, leo ac euismod consequat, nisl arcu interdum nunc, pellentesque vestibulum velit lectus et
            ligula. Praesent quis purus nec enim porta porta. Nulla sodales mollis massa vitae
            ultrices. Nullam in dolor elit, eu vulputate ligula.</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque facilisis quam at ante tempor tempor. Mauris
            condimentum dignissim fringilla. Fusce ut enim id augue dignissim molestie.
            Proin nec lacus non leo ullamcorper scelerisque vitae in arcu. Donec fermentum, leo ac euismod
            consequat, nisl arcu interdum nunc, pellentesque vestibulum velit lectus et ligula. Praesent quis purus nec
            enim porta porta. Nulla sodales mollis massa vitae ultrices. Nullam in dolor
            elit, eu vulputate ligula.</p></div>

    <table>
        <tr>
            <td class="element-cell">
                <div class="element-name"><img src="ico_tpl_class_off.png" width="24" height="24" alt="" title="">Tpl
                    classes
                </div>
                <div class="element">
    ...
    <table>
        <tr>
            <td class="element-cell">
                <div class="element-name"><img src="ico_code.png" width="24" height="24" alt="" title="">Style for Codes
                </div>
                <div class="element">
                    <code>code : Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis
                        nisl ut aliquip ex ea commodo Lorem ipsum dolor sit amet, consectetuer
                        adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat
                        volutpat.</code>
                    <div class="xoopsCode">.xoopsCode : Ut wisi enim ad minim veniam, quis nostrud exerci tation
                        ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo Lorem ipsum dolor sit amet,
            ...
            <td class="element-cell">
                <div class="element-name"><img src="ico_quote.png" width="24" height="24" alt="" title="">Style for
                    Quotes
                </div>
                <div class="element">
                    <blockquote>blockquote : Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper
                        suscipit lobortis nisl ut aliquip ex ea commodo Lorem ipsum dolor sit amet,
                        consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna
                        aliquam erat
                        volutpat.
                    </blockquote>
                    <div class="xoopsQuote">.xoopsQuote : Ut wisi enim ad minim veniam, quis nostrud exerci tation
                        ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo Lorem ipsum dolor sit
                ...
                <div class="element">
                    <fieldset>
                        ...
                        <form action="" method="" class="">
                            ...
                            <div>
                                <label>
                                    <input type="radio" name="RadioGroup1" value="Radio button" id="RadioGroup1_0"> Radio button</label>
                                <br>
                                    <label>
                                        <input type="radio" name="RadioGroup1" value="Radio button" id="RadioGroup1_1"> Radio button</label>
                                    <br>
                                        <label>
                            ...
                            <div>
                                <label>Select B (label)
                                    <select name="select2" size="5" id="select2">
                                        <option>Lorem ipsum 01</option>
                                        <option selected>Lorem ipsum 02</option>
                                        <option>Lorem ipsum 03</option>
                                        <option>Lorem ipsum 04</option>
                                        <option>Lorem ipsum 05</option>
                                    </select>
